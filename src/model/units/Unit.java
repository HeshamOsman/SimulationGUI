...
public abstract class Unit implements Simulatable, SOSResponder {
	...
	public void respond(Rescuable r)throws IncompatibleTargetException,CannotTreatException {
		...
		if(!(r instanceof ResidentialBuilding))
			throw new IncompatibleTargetException(this, r, "This Unit Can Only Respond To Residential Building Rescue Call");
		
		if(!canTreat(r)) {
			throw new CannotTreatException(this,r,"The target is not in need for this treat");
		}
